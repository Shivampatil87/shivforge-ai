            ...
            return <motion.div
              ...
              >
                <div className="relative h-40 bg-black cursor-pointer">
                  <iframe 
                       srcDoc={w.latestCode || '<html><body style="background:#111;display:flex;align-items:center;justify-content:center;height:100vh;margin:0"><p style="color:#555;font-family:sans-serif;font-size:13px">No preview available</p></body></html>'} 
                ...
                <div className="p-5 flex flex-col gap-4 flex-1">
                  ...
                  {!w.deployed ? (
                    <button onClick={(e)=>{e.stopPropagation(); handleDeploy(w._id)}} className="mt-auto flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-linear-to-r from-indigo-500 to-purple-500 hover:scale-105 transition">
                      <Rocket size={18} />
                      Deploy
                    </button>
                  ) : (
